...
func TestEndToEnd(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			//Issue with comparing jsons due to order change
			//assert.JSONEq(t, string(got), string(tc.fhir))
		})
	}
}
